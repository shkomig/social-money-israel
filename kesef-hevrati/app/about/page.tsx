...
export const metadata: Metadata = {
  ...
  description: 'מיזם חינמי שמרכז מחשבונים חכמים, אשף זכאות ומידע רשמי—כדי לא להשאיר כסף על השולחן.',
  alternates: {
  ...
  return (
    <main dir="rtl" className="mx-auto max-w-screen-md px-4 py-10 space-y-6 text-slate-700">
      ...
      <section className="space-y-2">
        ...
        <p className="leading-8">
          לא להשאיר כסף על השולחן. לעזור לכל אחד להבין במהירות אם הוא זכאי להטבה/החזר, ומה בדיוק
          עושים כדי לממש אותה.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="leading-8">
          אנחנו לא יועצים פיננסיים. המידע כללי ואינו תחליף לייעוץ אישי. ההכרעה הסופית תמיד אצל
          הגורמים הרשמיים.
        </p>
      </section>
