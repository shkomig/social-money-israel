    ...
    <html lang="he" dir="rtl">
      <head>
        ...
        <link
          ...
          type="image/avif"
        />
  {/* Preconnect hints: safe, low-risk origins observed in the codebase. */}
  <link rel="preconnect" href="https://calendar.google.com" crossOrigin="anonymous" />
  <link rel="preconnect" href="https://tax.gov.il" crossOrigin="anonymous" />
  {/* Same-origin preconnect can help with HTTP/2 early connection setup. */}
  <link rel="preconnect" href="https://social-money-israel.netlify.app" />
