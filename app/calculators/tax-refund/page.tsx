      ...
      <div dir="rtl" className="max-w-screen-md mx-auto p-4">
        ...
        <div className="mb-6">
          <HowItWorks
            ...
            steps={[
              { title: 'אוספים מסמכים', detail: 'טופסי 106, אישורי תרומות, לימודים והפקדות' },
              { title: 'ממלאים פרטים', detail: 'הכנסות, נקודות זיכוי וזיכויים רלוונטיים' },
              { title: 'מגישים בקשה', detail: 'הגשה לרשות המסים וקבלת ההחזר לחשבון' },
            ]}
            tips={[
              'שמרו קבלות ואישורים',
            ...
            sources={[
              { label: 'רשות המסים', url: 'https://tax.gov.il' },
            ]}
          />
        </div>
